            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "【절대 금지】 산재(산업재해), 노무, 노동법, 근로기준법, 직장 내 괴롭힘 법적 처리, "
                        "노동 권리·보상 관련 주제는 절대 선택하지 않습니다. "
                        "이 사이트의 주제는 오직 '직장인 통증 및 피로 — 원인부터 해결까지'입니다."
                    ),
                },
                {
                    "role": "user",
                    "content": (
                        ...
                        "【절대 제외 주제 — 어떤 경우에도 선택 불가】\n"
                        "- 산재(산업재해), 산재 신청·처리·보상 관련\n"
                        "- 노무, 노동법, 근로기준법, 고용 계약, 해고, 임금 체불\n"
                        "- 직장 내 괴롭힘 법적 대응, 노동 권리·소송\n"
                        "위 주제는 사이트 아이덴티티(직장인 통증·피로 해결)와 맞지 않아 완전히 배제한다.\n\n"
                        "{\n"
